      ...
      <Router>
        <div className="main-container">
          ...
          <Switch>
            ...
            <Route
              path="/TechDegree-Project-7-React"
              render={() => <Redirect to="/ocean" />}
            />
            <Route
              path="/ocean"
              render={() =>
                this.state.loading ? (
                  ...
                  <PhotoContainer data={this.state.ocean} />
                )
              }
            />
            <Route
              ...
              render={() =>
                this.state.loading ? (
                  ...
                  <PhotoContainer data={this.state.sun} />
                )
              }
            />
            <Route
              ...
              render={() =>
                this.state.loading ? (
                  ...
                  <PhotoContainer data={this.state.moon} />
                )
              }
            />
            <Route
